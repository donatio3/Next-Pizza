...
// Этот файл д=нужен для генераации данных
...
async function up() { // генерирует данные для бд
    await prisma.user.createMany({
        data: [
            {
                fullName: 'User Test',
                email: '2y2y2@example.com',
    ...
    const pizza1 = await prisma.product.create({
        data: {
          ...
          categoryId: 1,
          ingredients: { // подключ. связи между продуктами и ингредиентами - которые указаны в prisma.schema
